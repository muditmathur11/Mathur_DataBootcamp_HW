# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 02:44:46 2019
...
def welcome():
    return (
        f"Hawaii Climate Analysis API by Mudit Mathur<br/>"
        f"Surfs Up! Looking at preciptation in Hawaii to Plan a Trip<br/>"
        f"Please select from the routes below!:<br/>"
...
def precipitation():
    ...
    # Make a dictironary 
    dict_precip = {date: prcp for date, prcp in precip}
...
def temp_monthly():
    ...
    # Convert into a list 
    highest_list = list(np.ravel(highest_station))

    # JSONIFY the list and return
    return jsonify(highest_list)
